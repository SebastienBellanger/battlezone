...
(function() {
  var AxisModel, BackgroundHorizonModel, BackgroundMountainsModel, BattleZone, BulletModel, BulletNode, GRAVITY, Hud, Matrix3, Matrix4, Model, ModelLoader, Models, Node, OrthoProjection, Pipeline, Projection, Quaternion, Renderer, Sphere, TankBodyModel, TankChunkNode, TankNode, TankRadarModel, Tester, Transform, Vector3, Vector4, _barrelChunkData, _bodyChunkData, _chunkData, _sphereData,
  ...
  ModelLoader = (function() {
    ...
    ModelLoader.FromString = function(modelData) {
      var done, f1, f2, f3, f4, l, len, line, lines, model, v1, v2, v3, words;
      model = new Model();
      ...
      for (l = 0, len = lines.length; l < len; l++) {
        ...
        } else if (words.length === 4 && words[0] === "f") {
        ...
        } else if (words.length === 5 && words[0] === "f") {
          f1 = parseInt(words[1]) - 1;
          f2 = parseInt(words[2]) - 1;
          f3 = parseInt(words[3]) - 1;
  ...
  TankNode = (function(superClass) {
    ...
    TankNode.prototype.onRemove = function() {
      ...
      if (this.parent !== null) {
        ...
        chunk.transform.setTranslation(this.transform.translation);
        ...
        return this.parent.addChild(chunk);
      }
    };
  ...
  TankChunkNode = (function(superClass) {
    ...
    function TankChunkNode(model) {
      TankChunkNode.__super__.constructor.call(this, model);
      this.velocity = new Vector3(Math.random() * 6.0 - 3, Math.random() * 2 + 5, Math.random() * 6.0 - 3);
      this.rotationX = Math.random() * 10.0 - 5.0;
      this.rotationY = Math.random() * 10.0 - 5.0;
      this.rotationZ = Math.random() * 10.0 - 5.0;
    }
    ...
    TankChunkNode.prototype.onUpdate = function(step) {
      ...
      if (this.transform.translation.y <= 0.0) {
        return this.remove();
      }
    };
